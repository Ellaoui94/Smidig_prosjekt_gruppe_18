...
export function StudyPhilosophy() {
  //All student who study philosophy
  return (
    <>
      <Marker
        icon={{
      ...
      <Marker
        icon={{
          url: "https://tinypix.top/images/2022/05/31/KFcVg.png",
          scaledSize: { width: 70, height: 70 },
        }}
        position={{ lat: 59.931481, lng: 10.726923 }}
      >
        <InfoWindow position={{ lat: 59.934481, lng: 10.726923 }}>
          <div className={"info-window"}>
            <div>
              <h1>Casper Samuelsen</h1>
              <p>Filosofi</p>
              <p>Jobber alene idag! Full kons!</p>
            </div>
          </div>
        </InfoWindow>
      </Marker>
...
export function StudyDigitalTechnology() {
  //All student who study digTek
  return (
    <>
      <Marker
        icon={{
        ...
        position={{ lat: 59.944481, lng: 10.767923 }}
      >
        <InfoWindow position={{ lat: 59.947481, lng: 10.767923 }}>
          <div className={"info-window"}>
            <div>
              <h1>Noah Jensen</h1>
      ...
      <Marker
        ...
        position={{ lat: 59.931481, lng: 10.767923 }}
      >
        <InfoWindow position={{ lat: 59.934481, lng: 10.767923 }}>
          <div className={"info-window"}>
            <div>
              <h1>Karl Karlsen</h1>
              <p>Digital teknologi</p>
...
export function StudyProgramming() {
  //All student who study programming
  return (
    <>
      <Marker
        icon={{
        ...
        position={{ lat: 59.943481, lng: 10.737923 }}
      >
        <InfoWindow position={{ lat: 59.946481, lng: 10.737923 }}>
          <div className={"info-window"}>
            <div>
              <h1>Herman Tømmerås</h1>
              <p>Programmering</p>
...
function Map() {
  ...
  return (
    <>
      ...
      <GoogleMap
        zoom={14}
        center={{ lat: 59.914481, lng: 10.757923 }}
